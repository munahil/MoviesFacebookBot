...
const WIT_TOKEN='7A4GK73ZQ7W6ZHN7NJPHQSTCLTZFTEYL';
let FB_APP_SECRET='0f33b855c899395524decb79afa18788';
let FB_PAGE_TOKEN='EAAHfMPnnlysBAEt9ZAZCQcQpchMz9XkAayLyCap7kN1weE477G5EnD7r2aChCUZAp5DtF3j5sxh6miwZCd5WDSMC3JITS9qmqIBfZA8nK1bPyZCpSTerIC2BE0CKlXhN6AhDqFcZA6t3sznOJcaDmkyrZC33OW4icacSuVDqSsklSQZDZD'
try {
    ...
    //  console.log(`Wit extracted ${JSON.stringify(entities)}`);
      ...
      if (movie) {
        ...
        request({
          ...
          // console.log(`Inside API call body 33 : `+ JSON.stringify(body));

            if (!error && response.statusCode === 200) {
                // console.log(body) // Print the json response
                // console.log(body.Plot);

                context.details = body.Plot; // we should call an API here
...
var ssl_options = {
ca: fs.readFileSync('/var/www/ssl/ca_bundle.crt'),
